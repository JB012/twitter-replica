                ...
                <div className='flex flex-col pt-8 gap-y-10 justify-around h-full'>
                  <div className='page-option-item'>
                    <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg">
                      <path d="M 0 12.5 12.5 0 25 12.5 25 25 15.5 25 15.5 18.5 9.5 18.5 9.5 25 0 25 Z " fill="black"/>
                    </svg>
                    <a href="/" className='home-left-option'>Home</a>
                  </div>
                  <div className='page-option-item'>
                    <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg">
                        <path d="M 0 12.5 12.5 25 25 0 22 0 11.5 20 3 12.5 Z" fill="black" />
                    </svg>
                    <a href="/dailies" className='home-left-option'>Dailies</a>
                  </div>
                  <div className='page-option-item'>
                    <svg width="25" height="30" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="14" cy="13" r="7" fill="black" />
                      <path d="M 8 28 C 11 15.5 17 15.5 20 28" />
                    </svg>
                    <a href="/user" className='home-left-option'>Profile</a>
                  </div>
                  <div className='page-option-item'>
                    <svg className="isLight" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="black" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                    ...
                    <svg className="isDark hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                    ...
                    <button className='home-left-option' onClick={() => handleDisplayMode()}>Dark Mode</button>
                  </div> 
                </div>
              <div className='py-10'>
